...
pygame.display.set_caption('I am professional RACIST!')

# image
bg = pygame.image.load(r'C:\pp2\pp2-22B030512\TSIS8\racer\img\background.png')
carimg = pygame.image.load(r'C:\pp2\pp2-22B030512\TSIS8\racer\img\porsche_blue.png')
